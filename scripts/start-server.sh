...
if [ -z "$INS_V" ]; then
	...
	cd ${SERVER_DIR}
	wget -qi bedrock-server-${GAME_VERSION}.zip https://minecraft.azureedge.net/bin-linux/bedrock-server-${GAME_VERSION}.zip
    sleep 2
    ...
    wget -qi server.properties https://raw.githubusercontent.com/ich777/docker-minecraft-bedrock/master/config/server.properties
...
if [ ! -f ${SERVER_DIR}/server.properties ]; then
    ...
    wget -qi ${SERVER_DIR}/server.properties https://raw.githubusercontent.com/ich777/docker-minecraft-bedrock/master/config/server.properties
else
